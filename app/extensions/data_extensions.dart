...
extension MapId on Map<String, dynamic> {
  ...
  Map<String, dynamic> clean(
    ...
    newMap.removeWhere((key, value) =>
        value == null || key.isPath || ['id', 'tempId'].contains(key));
    newMap[field] = FieldValue.serverTimestamp();
    if (addUpdatedAt) {
      newMap['updatedAt'] = FieldValue.serverTimestamp();
    }
    if (addUser) {
      final user = UserProvider.instance.user;
      newMap['createdBy'] = user?.uid;
